...
static HOT_INLINE s16 max(const s16 a, const s16 b) noexcept
{
    return (a > b) ? a : b;
}

static HOT_INLINE u16 max(const u16 a, const u16 b) noexcept
{
    return (a > b) ? a : b;
}

static HOT_INLINE s64 max(const s64 a, const s64 b) noexcept
{
    return (a > b) ? a : b;
}

static HOT_INLINE u64 max(const u64 a, const u64 b) noexcept
{
    return (a > b) ? a : b;
}

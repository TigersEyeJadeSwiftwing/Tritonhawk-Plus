...
#ifndef THP_PLUG_IN_IMAGE_SHRINK
#define THP_PLUG_IN_IMAGE_SHRINK
                        ...
                        )
{
    ...
    Params->process_name = (string)THP_PLUG_IN_PROCESS_Image_Magic_Shrink;
    ...
    Params->run_mode_interactive = false;
    Params->image = image;
...
#endif // THP_PLUG_IN_IMAGE_SHRINK
